...
public class JobControlles {
    ...
    @Operation(summary = "Cadastro de vaga", description = "Essa função é responsavel por cadastra as vagas na empresa")
    @ApiResponses({
    ...
    public ResponseEntity<Object> create(@Valid @RequestBody CreateJobDTO createJobDTO, HttpServletRequest request){
        ...
        // se a company nao existir retorna o erro pro usuario
        try {
